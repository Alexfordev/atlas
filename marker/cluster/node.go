...
func (n *Node) keyFile() string         { return path.Join(n.Datadir, "atlas/nodekey") }
func (n *Node) staticNodesFile() string { return path.Join(n.Datadir, "/atlas/static-nodes.json") }
