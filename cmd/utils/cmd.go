...
func ImportChain(chain *chain.BlockChain, fn string) error {
...
func missingBlocks(chain *chain.BlockChain, blocks []*types.Block) []*types.Block {
...
func ExportChain(blockchain *chain.BlockChain, fn string) error {
...
func ExportAppendChain(blockchain *chain.BlockChain, fn string, first uint64, last uint64) error {
	log.Info("Exporting blockchain", "file", fn)
