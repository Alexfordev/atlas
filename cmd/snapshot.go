...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale map protocol state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
atlas snapshot prune-state <state-root>
...
during the use of Atlas, please also specify it here for correct deletion. Otherwise
