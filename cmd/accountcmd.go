...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage map protocol presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    atlas wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import map protocol presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	atlas wallet [options] /path/to/my/presale.wallet
...
between map protocol nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
	...
	atlas account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
	...
	atlas account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another map protocol instance,
...
func accountCreate(ctx *cli.Context) error {
	...
	fmt.Printf("BLS G1 Public key:   %s\n", blsG1PubKeyText)
