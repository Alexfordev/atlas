...
type SimulatedBackend struct {
	...
	blockchain *chain.BlockChain // Ethereum blockchain to handle the consensus
...
// A simulated backend always uses chainID 1337.
func NewSimulatedBackend(alloc chain.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
...
func (b *SimulatedBackend) Blockchain() *chain.BlockChain {
	return b.blockchain
}
