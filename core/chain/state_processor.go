...
func applyTransaction(msg types.Message, config *params.ChainConfig, bc abstract.ChainContext, author *common.Address, gp *core.GasPool, statedb *state.StateDB, blockNumber *big.Int, blockHash common.Hash, tx *types.Transaction, usedGas *uint64, evm *vm.EVM) (*types.Receipt, error) {
	...
	*usedGas += result.UsedGas
	...
	receipt.Logs = statedb.GetLogsAndResetBlockHash(tx.Hash(), blockHash)
