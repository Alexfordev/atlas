...
// block.
func genValueTx(nbytes int) func(int, *chain.BlockGen) {
...
func genTxRing(naccounts int) func(int, *chain.BlockGen) {
	from := 0
	return func(i int, gen *chain.BlockGen) {
...
func genUncles(i int, gen *chain.BlockGen) {
	if i >= 6 {
...
func benchInsertChain(b *testing.B, disk bool, gen func(int, *chain.BlockGen)) {
