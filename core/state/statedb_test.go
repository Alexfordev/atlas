...
func (test *snapshotTest) checkEqual(state, checkstate *StateDB) error {
	...
	if !reflect.DeepEqual(state.GetLogsAndResetBlockHash(common.Hash{}, common.Hash{}), checkstate.GetLogsAndResetBlockHash(common.Hash{}, common.Hash{})) {
		return fmt.Errorf("got GetLogs(common.Hash{}) == %v, want GetLogs(common.Hash{}) == %v",
			state.GetLogsAndResetBlockHash(common.Hash{}, common.Hash{}), checkstate.GetLogsAndResetBlockHash(common.Hash{}, common.Hash{}))
	}
	return nil
}
